...
%load data
addpath('C:\Users\ilbar\Documents\MATLAB\DreammistPaper')
...
%shared genes between the two comparisons
AlldiffGenesShared = intersect(dataStatsWT.Row_names, dataStatsHOM.Row_names);
