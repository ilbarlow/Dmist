...
all = [0.292693861	0.598026725	1;
0.328012986	1.041740826	1;
0.488800975	0.668047438	1];


figure;
b = bar(flip(nanmean(all)), 'Barwidth', 0.5);
b.FaceColor = [1 0 1];
hold on;
errorbar (flip(nanmean(all)), flip(nanstd(all)), '.k', 'Linewidth', 2)
ax = gca;
